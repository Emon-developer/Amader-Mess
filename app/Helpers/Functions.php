...
function sendMail()
{
    ...
    // $mail=Mail::send('emails.verifyCode', ['client'=>$client,'project'=>$project], function ($message) use ($client){
    //     $message
    //       ->from('programmer.arafatanwar@gmail.com', 'BUET')
    //       ->to($client->email,$client->email)
    //       ->subject('Verification Code for BUET');
    // });
}
